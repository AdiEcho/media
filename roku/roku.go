...
// activation can be nil
func (a *AccountToken) New(activation *ActivationToken) error {
   ...
   if activation != nil {
      req.Header.Set("x-roku-content-token", activation.V.Token)
   }
   resp, err := http.DefaultClient.Do(req)
   if err != nil {
      return err
...
func (a AccountToken) Code() (*ActivationCode, error) {
   ...
   return &ActivationCode{Data: data}, nil
}

func (a AccountToken) ActivationToken(
   code ActivationCode,
